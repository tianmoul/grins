...
// This class
#include "grins/physics_factory_immersed_boundary_one_d_solids.h"
...
namespace GRINS
{
  ...
  libMesh::UniquePtr<Physics> PhysicsFactoryImmersedBoundaryOneDSolids<DerivedPhysics>::build_physics( const GetPot& input,
                                                                                                       const std::string& physics_name )
  {
    ...
    if (solid_mech == std::string("ElasticCable"))
      {
  ...
  PhysicsFactoryImmersedBoundaryOneDSolids<ElasticCable> grins_factory_ibm_elastic_cable
  (PhysicsNaming::elastic_cable(),PhysicsNaming::immersed_boundary());
  
  PhysicsFactoryImmersedBoundaryOneDSolids<ElasticCableRayleighDamping> grins_factory_ibm_elastic_cable_rayleigh_damping
